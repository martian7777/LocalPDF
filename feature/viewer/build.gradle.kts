...
dependencies {
    implementation(project(":core:model")); implementation(project(":core:data")); implementation(project(":core:designsystem")); implementation(project(":feature:ocr-edit")); implementation(project(":feature:redaction"))
